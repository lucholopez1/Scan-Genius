...
def eliminar():
    ...
    if codigo_encontrado==True: 
        ...
        def reseteo():
            ...
            messagebox.showinfo("Exito","Se reseteó el producto con exito")
        ...
        boton2 = tk.Button(mini_interfaz, text="Elminar Unidades", command=elemento, bg="lightgreen")
    ...
    # en caso de encontrarse el codigo se le informara al usuario
        ...
        messagebox.showinfo("Error", "El producto que desea eliminar no se encuentra en la base de datos")
...
interfaz.configure(bg="ivory3")  # Fondo 
